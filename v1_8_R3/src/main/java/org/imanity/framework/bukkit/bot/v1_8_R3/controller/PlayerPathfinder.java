...
public class PlayerPathfinder {
    ...
    static {
        FieldResolver fieldResolver = new FieldResolver(PathPoint.class);
        E = fieldResolver.resolveSilent("e");
        F = fieldResolver.resolveSilent("f");
        G = fieldResolver.resolveSilent("g");
        H = fieldResolver.resolveSilent("h");
    }
}

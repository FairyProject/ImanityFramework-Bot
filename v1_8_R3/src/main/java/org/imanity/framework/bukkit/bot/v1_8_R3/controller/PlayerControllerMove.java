...
public class PlayerControllerMove extends ControllerMove {
    ...
    public PlayerControllerMove(EntityBot entityinsentient) {
        super(new EntitySlime(entityinsentient.world));
    ...
    public void c() {
        ...
        if (this.f) {
            ...
            NMSUtil.setHeadYaw(a, this.a.yaw);
            ...
            this.a.k(movement);
            this.a.ba = movement;
            if (shouldSlimeJump() || ((d2 >= a.S) && (d0 * d0 + d1 * d1 < 1.0D))) {
                this.h = cg();
                this.h /= 3;
